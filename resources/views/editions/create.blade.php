...
<form action="{{ route('editions.store') }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="date" name="date_diffusion" class="form-control @error('date_diffusion') is-invalid @enderror" value="{{ old('date_diffusion') }}">
        @error('date_diffusion') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
    <div class="mb-3">
        <label>Heure de diffusion</label>
        <input type="time" name="heure_diffusion" class="form-control @error('heure_diffusion') is-invalid @enderror" value="{{ old('heure_diffusion') }}">
    ...
    <div class="mb-3">
        ...
        <input type="number" name="duree_max_minutes" class="form-control @error('duree_max_minutes') is-invalid @enderror" value="{{ old('duree_max_minutes') }}">
